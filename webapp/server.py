...
cap.set(cv2.CAP_PROP_FRAME_WIDTH, int(os.environ.get('CAP_PROP_FRAME_WIDTH', 1280)))
cap.set(cv2.CAP_PROP_FRAME_HEIGHT, int(os.environ.get('CAP_PROP_FRAME_HEIGHT', 720)))
